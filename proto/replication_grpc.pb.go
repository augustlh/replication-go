...
const (
	...
	AuctionService_CheckHealth_FullMethodName = "/proto.AuctionService/CheckHealth"
	AuctionService_Replicate_FullMethodName   = "/proto.AuctionService/Replicate"
	AuctionService_Connect_FullMethodName     = "/proto.AuctionService/Connect"
)
...
type AuctionServiceClient interface {
	...
	CheckHealth(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*Heartbeat, error)
	Replicate(ctx context.Context, in *ReplicationRequest, opts ...grpc.CallOption) (*Ack, error)
...
func (c *auctionServiceClient) CheckHealth(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*Heartbeat, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Heartbeat)
	err := c.cc.Invoke(ctx, AuctionService_CheckHealth_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *auctionServiceClient) Replicate(ctx context.Context, in *ReplicationRequest, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
...
func (c *auctionServiceClient) Connect(ctx context.Context, in *ConnectRequest, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
	err := c.cc.Invoke(ctx, AuctionService_Connect_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuctionServiceServer interface {
	...
	CheckHealth(context.Context, *HealthRequest) (*Heartbeat, error)
	Replicate(context.Context, *ReplicationRequest) (*Ack, error)
...
func (UnimplementedAuctionServiceServer) CheckHealth(context.Context, *HealthRequest) (*Heartbeat, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckHealth not implemented")
}
func (UnimplementedAuctionServiceServer) Replicate(context.Context, *ReplicationRequest) (*Ack, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Replicate not implemented")
}
func (UnimplementedAuctionServiceServer) Connect(context.Context, *ConnectRequest) (*Ack, error) {
...
func _AuctionService_CheckHealth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HealthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuctionServiceServer).CheckHealth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuctionService_CheckHealth_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServiceServer).CheckHealth(ctx, req.(*HealthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AuctionService_Connect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConnectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuctionServiceServer).Connect(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuctionService_Connect_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServiceServer).Connect(ctx, req.(*ConnectRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuctionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuctionService_CheckHealth_Handler,
		},
		{
